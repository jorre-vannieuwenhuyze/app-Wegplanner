makeresult <- function(path,breedte) {HTML(
  "<h1>Winkel-/woonerf</h1>"
  ,"<p>Deze weg wordt op de eerste plaats gebruikt door voetgangers, maar dient ook als toegangsweg voor fietsers die er wonen of willen winkelen. Gemotoriseerd verkeer wordt hier zo veel mogelijk vermeden.</p>"
  ,characteristics(
     'Ondergrond' = 'Het lokale karakter wordt geaccentueerd door betonstraatstenen.'
    ,'Kleur'      = 'Niet bepaald, maar vermijd asfalt-grijs'
    ,'Snelheid'   = 'De maximum snelheid is 20km/u.' 
    ,'Markering'  = 'Er worden geen lijnelementen (bv. twee goten) gebruikt die een rijweg op welke manier dan ook kunnen sugereren. 
                     Aparte voetpaden ontbreken. Dit onderstreept dat deze weg op de eerste plaats voor wandelaars bedoeld is.'
    )
  ,voorbeeldplannen
