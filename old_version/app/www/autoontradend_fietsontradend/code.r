makeresult <- function(path,breedte) {HTML(
  ...
  ,voorbeeldplannen
  ,ifelse( 0.0 <= breedte & breedte <  1.8 ,toosmall,"")  
  ,ifelse( 1.8 <= breedte & breedte <  Inf,plan(path,"plan1"),'')
  ,praktijkvoorbeelden
  ...
  ,'<p class="figure"><iframe src="https://www.google.com/maps/embed?pb=!4v1619854295546!6m8!1m7!1sTvTIKvu3-dU3WM1ymrqUcQ!2m2!1d50.78790854469008!2d4.25198387417273!3f257.3452766136735!4f-6.028079880627146!5f0.7820865974627469" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p>'
)}