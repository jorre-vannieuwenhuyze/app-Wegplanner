...
features$message=warningbox("
    Een snelheidsregime van 30km/u op een verbindings- of ontsluitingsweg voor gemotoriseerd verkeer veronderstelt dat de weg in bebouwd gebied ligt. Het heeft geen zin om hier fietsen te ontraden.
