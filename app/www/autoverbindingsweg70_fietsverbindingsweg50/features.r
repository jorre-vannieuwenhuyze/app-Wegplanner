features <- list(
 title = "Autoweg 70km/u<br>met fietspaden"
,description = c(
  ...
  ,characteristicsTable(
    ...
    ,'Markering'  = 'Witte (stippel)lijn in het midden van de autorijweg duidt aan dat hier 70km/u mag gereden worden. Twee volle witte lijnen aan de randen van de fietspaden duiden aan dat hier 50km/u mag gereden worden.'
    )
  )
,plan = img("plan1")
,praktijkvoorbeelden = c(
   "<p class='caption'>Voorbeeld hieronder: parkeerstrook is afgeraden bij een snelheid van 70km/u. Fietspad ontbreekt belijning.</p>"
